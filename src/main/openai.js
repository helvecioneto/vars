 ...
 * @param {string} params.model - Model to use (should be vision-capable like gpt-4o)
...
async function analyzeImageOpenAI({
    ...
    // Models like gpt-4o, gpt-4o-mini, gpt-4-turbo support vision
    ...
    // Use tier config for parameters
    ...
    // Temperature handling for newer models
